...
namespace MicroBase.Share.Extensions
{
    public static class CollectionExtensions
    {
        ...
        public static IDictionary<TKey, TValue> SafeToDictionary<TSource, TKey, TValue>(
        ...
        public static async Task<IEnumerable<TResult>> SelectAsync<TSource, TResult>(
            this IEnumerable<TSource> enumerable, Func<TSource, Task<TResult>> selector)
        {
            ...
            Func<T, string> textFieldSelector)
        {
            ...
            var list = new SelectList(values, "ValueField", "TextField");
            return list;
        }
            ...
            int selectedValue)
        {
            ...
            var list = new SelectList(values, "ValueField", "TextField", selectedValue);
            return list;
        }

        public static List<NameValueModel<string>> ToNameValueModel(this Dictionary<string, string> dics, string defaultValue)
        {
            var res = new List<NameValueModel<string>>
            {
                new NameValueModel<string>
                {
                    Name = defaultValue,
                    Value = string.Empty
                }
            ...
            res.AddRange(dics.Select(s => new NameValueModel<string>
            {
                Value = s.Key,
                Name = s.Value
            }));
        ...
        public static List<SelectListItem> ToSelectListItem(this Dictionary<string, string> dics,
            string defaultValue,
            string selectedValue)
        {
            var res = new List<SelectListItem>();
            res.AddRange(dics.Select(s => new SelectListItem
            {
                Value = s.Key,
                Text = s.Value,
                Selected = selectedValue == s.Key
            }));
